...
all_images = glob.glob("/mnt/netstore1_home/behrooz.mansouri/SIGIRSciDis/25_04/figures/images/*.png")[:10]
...
output_path = "/home/adah.holt/Desktop/scientific-discovery/ret_result.tsv"
with open(output_path, "w", newline="") as f:
    writer = csv.writer(f, delimiter="\t")
    writer.writerow(["query_id", "0", "fig_id", "rank", "relevance"])

    for entry in test_queries[:10]:
